...
import Birthday from '/src/assets/birthday.jpg';
...
export const Slide1 = ({onNext, onPrevious}: SlideProps) => {
    ...
    return (
        <div className="max-w-sm rounded overflow-hidden shadow-lg">
            ...
            <div className="font-extrabold text-xl text-dark-brand mb-2">What's your birthday?</div>
            <p className="text-gray-700 text-base">
            this information will help us pick the perfect plan for you
            </p>
        </div>
        <input 
            onSubmit={handleNext}
