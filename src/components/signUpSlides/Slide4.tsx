...
import Budget from '/src/assets/money.jpg';
...
export const Slide4 = ({onNext, onPrevious}: SlideProps) => {
    ...
    return (
        <div className="max-w-sm rounded overflow-hidden shadow-lg">
            ...
            <div className="font-extrabold text-xl text-dark-brand mb-2">What's your budget?</div>
            <p className="text-gray-700 text-base">
            this information will help us pick a plan that's the best value for you
            </p>
        </div>
        <input 
            onSubmit={handleNext}
